...
public class AuthorizationBuilder {
    ...
    public AuthorizationBuilder(){authorization = new Authorization();}

    public AuthorizationBuilder(Authorization authorization){this.authorization = authorization;}
    ...
    public Authorization build(){return this.authorization;}
}